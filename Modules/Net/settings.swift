...
internal class Settings: NSStackView, Settings_v, NSTextFieldDelegate {
    ...
    private var hideSystemProcessesState: Bool = true
    ...
    public init(_ module: ModuleType) {
        ...
        self.hideSystemProcessesState = Store.shared.bool(key: "\(self.title)_hideSystemProcesses", defaultValue: self.hideSystemProcessesState)
    ...
    public func load(widgets: [widget_t]) {
        ...
        self.addArrangedSubview(PreferencesSection([
            ...
            PreferencesRow(localizedString("Hide system processes"), component: switchView(
                action: #selector(self.toggleHideSystemProcesses),
                state: self.hideSystemProcessesState
            ))
        ]))
    ...
    @objc private func toggleHideSystemProcesses(_ sender: NSControl) {
        self.hideSystemProcessesState = controlState(sender)
        Store.shared.set(key: "\(self.title)_hideSystemProcesses", value: self.hideSystemProcessesState)
    }
